async def test_resend_otp_success(
    unit_client, mock_registration_cases, mock_send_email_registration
) -> None:
    payload = {
    ...
    mock_send_email_registration.assert_called_once_with(
...
async def test_resend_otp_invalid_email(
    ...
    mock_send_email_registration.assert_not_called()
